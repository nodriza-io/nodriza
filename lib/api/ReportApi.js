...
var Report = /*#__PURE__*/function (_Request) {
  _inherits(Report, _Request);
  ...
  */
  ...
  _createClass(Report, [{
    key: "download",
    value: function download(params, callback) {
      var url = '/v1/report/download';
    ...
    */
    ...
    key: "ranges",
    value: function ranges(callback) {
      this.get('/v1/report/ranges', function (err, data) {
        if (err) return callback(err);
        callback(null, data);
      });
    }
