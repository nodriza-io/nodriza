...
var Snippet = /*#__PURE__*/function (_Request) {
  _inherits(Snippet, _Request);

  var _super = _createSuper(Snippet);
  ...
  */
  ...
  _createClass(Snippet, [{
    key: "updateSnippetSku",
    value: function updateSnippetSku(body, callback) {
      var params = {
        url: '/v1/snippet/updateSnippetSku',
        body: body
      };
