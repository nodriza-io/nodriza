...
var User = exports.User = function (_Request) {
  ...
  _createClass(User, [{
    ...
    value: function changeStatus(body, callback) {
      var params = { url: '/v1/user/changeStatus', body: body };
      this.put(params, function (err, data) {
        if (err) return callback(err);
        callback(null, data);
      });
    ...
    value: function loginChromeAgent(body, callback) {
      var params = { url: '/v1/user/loginChromeAgent', body: body };
      this.post(params, function (err, data) {
        if (err) return callback(err);
        callback(null, data);
      });
    ...
    value: function loginFromAgent(body, callback) {
      var params = { url: '/v1/user/loginFromAgent', body: body };
      this.post(params, function (err, data) {
        if (err) return callback(err);
        callback(null, data);
      });
    ...
    value: function updateRoles(body, callback) {
      var params = { url: '/v1/user/updateRoles', body: body };
      this.put(params, function (err, data) {
        if (err) return callback(err);
        callback(null, data);
      });
