  ...
  */
  ...
  _createClass(User, [{
    ...
    */
    ...
    key: 'logout',
    value: function logout(body, callback) {
      var params = { url: '/v1/user/logout', body: body };
    ...
    */
    ...
    value: function logoutAllDevices(body, callback) {
      var params = { url: '/v1/user/logoutAllDevices', body: body };
      this.delete(params, function (err, data) {
        if (err) return callback(err);
        callback(null, data);
      });
