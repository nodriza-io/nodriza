...
var Signature = /*#__PURE__*/function (_Request) {
  _inherits(Signature, _Request);
  ...
  */
  ...
  _createClass(Signature, [{
    key: "board",
    value: function board(params, callback) {
      this.get('/v1/signature/board/{type}/' + params['signatureId'], function (err, data) {
    ...
    */
    ...
    key: "register",
    value: function register(body, callback) {
      var params = {
        url: '/v1/signature/register',
        body: body
      };
    ...
    */
    ...
    key: "sendEmailValidation",
    value: function sendEmailValidation(body, callback) {
      var params = {
        url: '/v1/signature/sendEmailValidation',
        body: body
      };
      this.post(params, function (err, data) {
        if (err) return callback(err);
    ...
    */
    ...
    key: "verifyEmail",
    value: function verifyEmail(body, callback) {
      var params = {
        url: '/v1/signature/verifyEmail',
        body: body
      };
