...
var CustomApi = /*#__PURE__*/function (_Request) {
  _inherits(CustomApi, _Request);

  var _super = _createSuper(CustomApi);

  function CustomApi(params) {
