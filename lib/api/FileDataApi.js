...
var FileData = /*#__PURE__*/function (_Request) {
  _inherits(FileData, _Request);

  var _super = _createSuper(FileData);
  ...
  */
  ...
  _createClass(FileData, [{
    ...
    */
    ...
    key: "getUserQuota",
    value: function getUserQuota(params, callback) {
      var url = '/v1/fileData/getUserQuota';
    ...
    */
    ...
    key: "upload",
    value: function upload(body, callback) {
      var params = {
        url: '/v1/fileData/upload',
        body: body
      };
