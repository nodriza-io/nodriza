...
var model = 'proposalbot';

var Proposalbot = /*#__PURE__*/function (_Request) {
  _inherits(Proposalbot, _Request);

  var _super = _createSuper(Proposalbot);

  function Proposalbot(params) {
    _classCallCheck(this, Proposalbot);
  ...
  */
  ...
  _createClass(Proposalbot, [{
    key: "generate",
    value: function generate(body, callback) {
      var params = {
        url: '/v1/proposalbot/generate',
        body: body
      };
...
exports.Proposalbot = Proposalbot;