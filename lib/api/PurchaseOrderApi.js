...
var PurchaseOrder = /*#__PURE__*/function (_Request) {
  _inherits(PurchaseOrder, _Request);

  var _super = _createSuper(PurchaseOrder);
  ...
  */
  ...
  _createClass(PurchaseOrder, [{
    ...
    value: function changeStatus(body, callback) {
      var params = {
        url: '/v1/purchaseOrder/changeStatus',
        body: body
      };
    ...
    /**
    * PUT /v1/purchaseOrder/starred [PRIVATE]
    *
